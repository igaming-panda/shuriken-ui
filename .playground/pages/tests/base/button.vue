...
<template>
  <div>
    <NuiPreviewContainer title="BaseButton">
      ...
      >
        <div class="flex flex-wrap items-end gap-4">
          <BaseButton to="#" rounded="none">Button</BaseButton>
          <BaseButton to="#" rounded="sm">Button</BaseButton>
          <BaseButton to="#" rounded="md">Button</BaseButton>
          <BaseButton to="#" rounded="lg">Button</BaseButton>
          <BaseButton to="#" rounded="full">Button</BaseButton>
        </div>
      </NuiPreview>
